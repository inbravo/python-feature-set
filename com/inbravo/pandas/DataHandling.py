...
# Create another series of Strings and pass the index
series2 = pd.Series(['kavi', 'shyam', 'ravi'], index=[1, 2, 3])
print("A series of numbers: " + series2)

series3 = pd.Series([2, 3, 4], index=['jan', 'feb', 'mar'])
print(series3)
